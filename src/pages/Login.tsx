...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setIsLoading(false);
    toast({ title: "Welcome back!", description: `Logged in to Hireque as ${role}.` });
         ...
         <div className="w-full max-w-[420px] relative z-10">
            ...
            >
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <Button variant="outline" type="button" className="h-14 rounded-full border-primary/20 hover:border-primary hover:bg-transparent w-full font-bold text-[15px] text-primary shadow-sm bg-transparent transition-colors">
