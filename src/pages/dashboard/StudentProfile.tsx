    ...
    <DashboardLayout role="student">
      <div className="space-y-8 max-w-5xl mx-auto">
        <div className="flex justify-between items-end">
          ...
          <Button className="rounded-full shadow-lg shadow-primary/20 bg-primary text-white font-bold h-10 px-6 hidden sm:flex">
            ...
            <div className="space-y-8">
                ...
                >
                    ...
                    <div className="flex gap-3 mt-6 relative z-10">
                        <Button variant="outline" size="icon" className="rounded-full border-primary/10 text-primary hover:bg-secondary"><Linkedin className="w-4 h-4" /></Button>
                        <Button variant="outline" size="icon" className="rounded-full border-primary/10 text-primary hover:bg-secondary"><Github className="w-4 h-4" /></Button>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <Button variant="outline" className="w-full mt-4 rounded-full font-bold border-primary/20 text-primary hover:bg-primary/5 text-xs"><FileText className="w-3 h-3 mr-2" /> Upgrade Resume</Button>
                </motion.div>
            </div>
